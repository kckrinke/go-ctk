...
func MakeButtonBox() *CButtonBox {
	return NewButtonBox(cdk.ORIENTATION_HORIZONTAL, false, 0)
}
...
func (b *CButtonBox) Init() (already bool) {
	...
	// b.CBox.PackStart(nilWidget, true, false, 0)
	b.CBox.PackEnd(NewBox(orientation, false, spacing), false, true, 0)
	_ = b.InstallProperty(PropertyLayoutStyle, cdk.StructProperty, true, LayoutStart)
	// if secondary := b.getSecondary(); secondary != nil {
	// secondary.SetBoolProperty(PropertyDebug, true)
	// secondary.SetBoolProperty(PropertyDebugChildren, true)
	// }
	return false
}
