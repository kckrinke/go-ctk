...
func (o *CObject) Init() (already bool) {
	...
	o.CObject.Init()
	o.origin = &cdk.Point2I{}
	o.allocation = &cdk.Rectangle{}
...
func (o *CObject) SetOrigin(x, y int) {
	if f := o.Emit(SignalOrigin, o, cdk.MakePoint2I(x, y)); f == cdk.EVENT_PASS {
		o.origin.Set(x, y)
	}
}
...
func (o *CObject) SetAllocation(size cdk.Rectangle) {
	if f := o.Emit(SignalAllocation, o.allocation, size); f == cdk.EVENT_PASS {
...
func (o *CObject) Draw(canvas cdk.Canvas) cdk.EventFlag {
	return o.Emit(SignalDraw, o, canvas)
}
...
func (o *CObject) SetTextDirection(direction TextDirection) {
	if f := o.Emit(SignalTextDirection, o, direction); f == cdk.EVENT_PASS {
...
func (o *CObject) GetCssColor(name cdk.Property) (value cdk.Color, err error) {
	if prop := o.GetCssProperty(name); prop != nil {
		if prop.Type() == cdk.ColorProperty {
			if v, ok := prop.Value().(cdk.Color); ok {
				return v, nil
			}
			if v, ok := prop.Default().(cdk.Color); ok {
				return v, nil
			}
		}
